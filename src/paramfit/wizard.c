...
void genetic_wizard(global_options_struct *global_options, FILE *file)
{
  ...
  global_options->MUTATION_RATE=get_float();
  ...
  global_options->PARENT_PERCENT=get_float();
  ...
  global_options->SEARCH_SPACE=get_float();
...
void simplex_wizard(global_options_struct *global_options, FILE *file)
{
  ...
  global_options->CONV_LIMIT = get_float();
