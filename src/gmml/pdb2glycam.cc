...
int main(int argc, char* argv[])
{
    ...
    std::string home = getEnvVar("MSANDERHOME");
    amino_libs.push_back(home + "/dat/leap/lib/amino12.lib");
    amino_libs.push_back(home + "/dat/leap/lib/aminoct12.lib");
    amino_libs.push_back(home + "/dat/leap/lib/aminont12.lib");
    std::string prep = home + "/dat/leap/prep/GLYCAM_06j-1.prep";
