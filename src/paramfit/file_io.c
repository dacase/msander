  ...
  while (strncmp(line, "#",1)!=0) {
    ...
    for (i=0; i<parm_datas[0].unique_bonds_found; ++i) {
      ...
      if (strncmp(parm_datas[0].bond_data[i].atom_type1,a1,NAME_SIZE)==0 &&
        ...
        break;
      else if (strncmp(parm_datas[0].bond_data[i].atom_type1,a2,NAME_SIZE)==0 &&
               strncmp(parm_datas[0].bond_data[i].atom_type2,a1,NAME_SIZE)==0 )
        break;
    }
  ...
  while (strncmp(line,"#",1)!=0) {
    ...
    for (i=0; i<parm_datas[0].unique_angles_found; ++i) {
      if (strncmp(parm_datas[0].angle_data[i].atom_type1,a1,NAME_SIZE)==0 && 
        ...
        break;
      else if (strncmp(parm_datas[0].angle_data[i].atom_type1,a3,NAME_SIZE)==0 && 
               strncmp(parm_datas[0].angle_data[i].atom_type2,a2,NAME_SIZE)==0 && 
               strncmp(parm_datas[0].angle_data[i].atom_type3,a1,NAME_SIZE)==0 )
        break;
    }
  ...
  while (!feof(fptr)) {
    ...
    for (i=0; i<parm_datas[0].unique_dihedrals_found; ++i) {
      if (strncmp(parm_datas[0].dihedral_data[i].atom_type1,a1,NAME_SIZE)==0 &&
        ...
        break;
      else if (strncmp(parm_datas[0].dihedral_data[i].atom_type1,a4,NAME_SIZE)==0 &&
               strncmp(parm_datas[0].dihedral_data[i].atom_type2,a3,NAME_SIZE)==0 &&
               strncmp(parm_datas[0].dihedral_data[i].atom_type3,a2,NAME_SIZE)==0 &&
               strncmp(parm_datas[0].dihedral_data[i].atom_type4,a1,NAME_SIZE)==0)
        break;
    }
