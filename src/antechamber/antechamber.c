...
void usage()
{
    if (strcmp(COLORTEXT, "YES") == 0 || strcmp(COLORTEXT, "yes") == 0) {
        printf("[31mUsage: antechamber -i  [0m input file name\n"
               ...
               "[31m                   -gk [0m gaussian job keyword, inside quotes\n"
        ...
        printf("Usage: antechamber -i  input file name\n"
               ...
               "                   -ek mopac or sqm keyword(s), inside quotes; overwrites previous ones\n"
...
void list()
{
    ...
    if (strcmp(COLORTEXT, "YES") == 0 || strcmp(COLORTEXT, "yes") == 0) {
        printf("	         	    [31m List of the File Formats [0m \n"
             ...
             "\n		Component cif      ccif    27  | GAMESS dat         gamess 27"
             "\n		--------------------------------------------------------------\n"
...
/*      allocate memory using default parameters MAXATOM and MAXBOND */
    ...
    if (checkformat) {
        printf("acdoctor mode is on: check and diagnosis problems in the input file.\n");
    }
...
/*      write out files */
    if (strcmp("ac", cinfo.outtype) == 0 || strcmp("1", cinfo.outtype) == 0) {
        ...
        wgout();
    } else if (strcmp("gamess", cinfo.outtype) == 0 || strcmp("27", cinfo.outtype) == 0) {
        wgamess();
